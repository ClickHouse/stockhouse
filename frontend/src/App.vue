<template>
  <div class="flex flex-col h-full">
    ...
    <MarketView
      ...
      :table-query="crypto.currentLiveQuery.value"
      :spread-query="crypto.currentSpreadQuery.value"
    ...
    <MarketView
      ...
      :table-query="stock.currentLiveQuery.value"
      :spread-query="stock.currentSpreadQuery.value"
